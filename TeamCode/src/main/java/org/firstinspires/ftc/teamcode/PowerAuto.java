...
@Autonomous(name = "PowerShots", group = "team")
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (currentstep == 3) {
                ...
                /*OmniTurn("Right",0.125,12);
                OmniDrive("Backward",0.25,100);
                OmniDrive("Right",0.25,400);  //600
